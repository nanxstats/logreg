...
For the SELO model, we can see the shrinkage effect and apparent sparsity in the estimation results. Note that the near-zero coefficients are not estimated as exactly 0, due to the limitation of our unconstrained gradient-based optimization method.
